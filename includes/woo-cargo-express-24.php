...
if ( !class_exists( 'Cargo_Express_24_Method' ) ) {
    class Cargo_Express_24_Method extends WC_Shipping_Method {
		...
		public function init_form_fields() {
			$this->instance_form_fields = [
				'title' => [
					...
					'default' => esc_html__( 'שילוח עד הבית CARGO Express 24', 'cargo-shipping-location-for-woocommerce' )
				],
				'shipping_cost' => [
